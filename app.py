...
def inject_custom_css(bg_base64, logo_base64):
    ...
    /* HOME BUTTON */
    .home-btn {{ display: flex; align-items: center; justify-content: center; background: rgba(30,41,59,0.1); color: #0f172a; padding: 8px 12px; border-radius: 8px; border: 1px solid rgba(0,0,0,0.1); cursor: pointer; text-decoration: none; transition: all 0.2s ease; }}
    ...
    /* KEMBALIKAN UI KARTU CANTIK UNTUK TIMELINE SCROLL */
...
# =====================================================================
# 7. HALAMAN UTAMA (TIMELINE SCROLL) - MENGEMBALIKAN UI KARTU LENGKAP
# =====================================================================
def ui_timeline(df_j, df_i):
    ...
    # PEMBENTUKAN HTML DENGAN STRUKTUR CSS KARTU DAN BADGE LENGKAP
        ...
        if d_str in df_j.columns:
            ...
            if not day_df.empty:
                for _, row in day_df.iterrows():
                    ...
                    # Membungkus nama dan badge dalam scroll-item (seperti versi awal)
...
if __name__ == "__main__":
    ...
    if st.session_state.active_menu == "Dashboard":
        ...
        # Panggil timeline yang sudah dikembalikan ke desain cantiknya
